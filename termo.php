...
return ("Esta política de Termos de Uso é válida a partir de Jun 2022.
TERMOS DE USO — Tech21

Tech21, pessoa jurídica de direito privado descreve, através deste documento, as regras de uso do site condor2708.startdedicated.com/ e qualquer outro site, loja ou aplicativo operado pelo proprietário.
...
A utilização deste website após as alterações significa que você aceitou os Termos de Uso revisados. Caso, após a leitura da versão revisada, você não esteja de acordo com seus termos, favor encerrar o seu acesso.
    ...
    A utilização deste website acarreta a adesão aos presentes Termos de Uso e a versão mais atualizada da Política de Privacidade de Tech21.
    Seção 3 - Condições de acesso

    Em geral, o acesso ao website da Tech21 possui caráter gratuito e não exige prévia inscrição ou registro.
    ...
    Partes deste website oferecem ao usuário a opção de publicar comentários em determinadas áreas. Tech21 não consente com a publicação de conteúdos que tenham natureza discriminatória, ofensiva ou ilícita, ou ainda infrinjam direitos de autor ou quaisquer outros direitos de terceiros.
    ...
    Todos os elementos de Tech21 são de propriedade intelectual da mesma ou de seus licenciados. Estes Termos ou a utilização do website não concede a você qualquer licença ou direito de uso dos direitos de propriedade intelectual da Tech21 ou de terceiros.
    ...
    O website no todo ou em cada uma das suas seções, pode ser encerrado, suspenso ou interrompido unilateralmente por Tech21, a qualquer momento e sem necessidade de prévio aviso.
    Seção 8 - Dados pessoais

    Durante a utilização deste website, certos dados pessoais serão coletados e tratados por Tech21 e/ou pelos Parceiros. As regras relacionadas ao tratamento de dados pessoais de Tech21 estão estipuladas na Política de Privacidade.
    Seção 9 - Contato

    Caso você tenha qualquer dúvida sobre os Termos de Uso, por favor, entre em contato pelo e-mail pedro.hsdeus@hotmail.com.");
